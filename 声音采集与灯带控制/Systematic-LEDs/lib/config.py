...
settings = {                                                      # All settings are stored in this dict
    ...
    "configuration":{  # Program configuration
                     ...
                     'FPS': 30,                                   # Desired refresh rate of the visualization (frames per second)
    ...
    "devices":{"Desk Strip":{
                      "configuration":{"TYPE": "ESP8266",                           # Device type (see below for all supported boards)
                                       ...
                                       "UDP_IP": "10.0.0.156",                   # IP address of the ESP8266. Must match IP in ws2812_controller.ino
                                       ...
                                       "MAX_BRIGHTNESS": 250,                       # Max brightness of output (0-255) (my strip sometimes bugs out with high brightness)
                                         # Other configuration 
                                       "N_PIXELS": 30,                             # Number of pixels in the LED strip (must match ESP8266 firmware)
